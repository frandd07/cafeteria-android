        ...
        ItemTouchHelper.SimpleCallback swipeCallback =
                new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
                    ...
                    @Override public void onSwiped(RecyclerView.ViewHolder vh, int dir) {
                        ...
                        tvMessage.setText("Esta acción no se puede deshacer. ¿Estás seguro que deseas eliminar este usuario y todos sus datos asociados?");
                                        ...
                                        @Override public void onResponse(Call<Void> c, Response<Void> r) {
                                            if (r.isSuccessful()) {
                                                ...
                                                Toasty.success(getContext(),
                                                        "Usuario eliminado", Toasty.LENGTH_SHORT, true).show();
                                            } else {
                                                Toasty.error(getContext(),
                                                        "Error al eliminar", Toasty.LENGTH_SHORT, true).show();
                                            }
                                        }
                                        @Override public void onFailure(Call<Void> c, Throwable t) {
                                            Toasty.error(getContext(),
